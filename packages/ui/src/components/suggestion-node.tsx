...
import type { SuggestionConfig } from '@workspace/ui/components/editor/plugins/suggestion-kit';
import { voidRemoveSuggestionOverlayVariants } from '@workspace/ui/components/suggestion-node-static';
